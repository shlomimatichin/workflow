...
SECRET_KEY = 'b%f*^f*q+t)z(altova4taw88dx6*oo)@q-g5by5s3vk&amp;+&amp;(%j'
...
TEMPLATE_DIRS = (
	'workflow/ticket/templates',
	'workflow/customworkflow/templates',
	'workflow/calendar/templates',
	'workflow/timemachine/templates',
	'workflow/templates',
)
